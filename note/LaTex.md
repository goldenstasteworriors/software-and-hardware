...
2. 上下标：用'_'连接表示下标，用'\^'连接表示上标，如$a^5$`&&a^5&&`,$a_i$`$$a_i$$`，但如果上下标多于一个字符，就要用{}进行包裹，如$x^{y+z}$`$x^{y+z}$`
...
$$
(M+m)s^2Y-mLs^2\theta=F\\
(\overline{I}+mL^2)s^2\theta-mLs^2Y-mgL\theta=0\\
G_1(s)=Y/F= \frac{1}{(M+m)s^2}\\
G_2(s)=\frac{mLs^2}{(\overline{I}+mL^2-mgL)}
$$

           -51
----------------------
  2.21e07 s^2 + 5.388e04
$$
U=\frac{1}{2}k_1\dot{\theta_1^2}+\frac{1}{2}k_2\dot{\theta_2^2}+\frac{1}{2}k_3\dot{\theta_3^2}+\frac{1}{2}k_4\dot{\theta_4^2}+\frac{1}{2}k_5\dot{\theta_5^2}+\frac{1}{2}k_6\dot{\theta_1^2}+m_1g_1y_{c1}+m_2g_2y_{c2}+m_3g_3y_{c3}+m_4g_4y_{c4}+m_5g_5y_{c5}+m_6g_6y_{c6}
$$
