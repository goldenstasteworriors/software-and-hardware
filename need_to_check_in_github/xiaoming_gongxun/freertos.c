...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(ComTask, Com_Task, 1, 0, 128);
  ...
  osThreadDef(MearmTask, Mearm_Task, 0, 0, 128);
  MearmTaskHandle = osThreadCreate(osThread(MearmTask), NULL);

  /* definition and creation of MotcorTask */
  osThreadDef(MotcorTask, Motcor_Task, osPriorityIdle, 0, 128);
  ...
  osThreadDef(MotorTask, Motor_Task, 0, 0, 128);
