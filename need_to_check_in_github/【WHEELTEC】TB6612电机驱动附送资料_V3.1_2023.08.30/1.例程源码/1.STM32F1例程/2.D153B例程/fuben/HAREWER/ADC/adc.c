...
void adc2_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA|RCC_APB2Periph_ADC2, ENABLE);	//开启GPIOA和ADC2时钟
	...
	ADC_Init(ADC2, &ADC_InitStructure);	//ADC初始化使用adc1
